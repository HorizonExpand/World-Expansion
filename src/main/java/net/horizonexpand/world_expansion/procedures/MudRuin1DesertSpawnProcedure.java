...
public class MudRuin1DesertSpawnProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		TopSoilTagName = "forge:top_soil_for_structures_desert";
		UnderSoilTagName = "forge:under_soil_for_structures_desert";
		Air = new ItemStack(Blocks.AIR);
		TopSoil = new ItemStack(Blocks.SAND);
		UnderSoil = new ItemStack(Blocks.SAND);
		PositionOffsetX = x + 0;
		PositionOffsetZ = z + 0;
		StructureSizeX = 7;
		StructureSizeZ = 7;
