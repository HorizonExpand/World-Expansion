			...
			if ((itemstack.getOrCreateTag().getString(("" + itemstack.getOrCreateTag().getDouble("total")))).equals(ForgeRegistries.ITEMS.getKey(WorldExpansionModItems.LIVE_SHOTGUN_BULLET.get()).toString())) {
				...
				entity.setDeltaMovement(new Vec3(
						(entity.getLookAngle().x * (-0.1)
								* (entity instanceof LivingEntity _livingEntity32 && _livingEntity32.getAttributes().hasAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get())
										? _livingEntity32.getAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get()).getBaseValue()
										: 0)),
						(entity.getLookAngle().y * (-0.1)
								* (entity instanceof LivingEntity _livingEntity34 && _livingEntity34.getAttributes().hasAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get())
										? _livingEntity34.getAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get()).getBaseValue()
										: 0)),
						(entity.getLookAngle().z * (-0.1)
								* (entity instanceof LivingEntity _livingEntity36 && _livingEntity36.getAttributes().hasAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get())
										? _livingEntity36.getAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get()).getBaseValue()
										: 0))));
				{
					Entity _ent = entity;
					_ent.setYRot(entity.getYRot());
					_ent.setXRot((float) (entity.getXRot() - 10 * (entity instanceof LivingEntity _livingEntity40 && _livingEntity40.getAttributes().hasAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get())
							? _livingEntity40.getAttribute(WorldExpansionModAttributes.KICKBACK_MULTIPLIER.get()).getBaseValue()
							: 0)));
