...
public class MudRuin1BadlandsSpawnProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		TopSoilTagName = "forge:top_soil_for_structures_badlands";
		UnderSoilTagName = "forge:under_soil_for_structures_badlands";
		Air = new ItemStack(Blocks.AIR);
		TopSoil = new ItemStack(Blocks.TERRACOTTA);
		UnderSoil = new ItemStack(Blocks.TERRACOTTA);
		PositionOffsetX = x + 0;
		PositionOffsetZ = z + 0;
		StructureSizeX = 7;
		StructureSizeZ = 7;
