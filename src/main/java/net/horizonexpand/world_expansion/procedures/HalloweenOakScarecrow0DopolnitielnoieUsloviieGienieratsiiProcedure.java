...
public class HalloweenOakScarecrow0DopolnitielnoieUsloviieGienieratsiiProcedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		EnableTagSupport = false;
		AirTagName = "namespace:tag";
		TopSoilTagName = "namespace:tag";
		UnderSoilTagName = "namespace:tag";
		Air = new ItemStack(Blocks.AIR);
		TopSoil = new ItemStack(Blocks.FARMLAND);
