	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, HashMap guistate) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == WorldExpansionModBlocks.CANNON_BARREL.get() && world.isEmptyBlock(BlockPos.containing(x, y + 2, z))) {
			if ((new Object() {
				...
				if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).getItem() == Items.POWDER_SNOW_BUCKET) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
