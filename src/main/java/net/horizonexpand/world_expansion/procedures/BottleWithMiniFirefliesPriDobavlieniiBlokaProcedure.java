...
public class BottleWithMiniFirefliesPriDobavlieniiBlokaProcedure {
		...
		if (!world.getBlockState(BlockPos.containing(x, y - 1, z)).canOcclude() && !world.isEmptyBlock(BlockPos.containing(x, y + 1, z))) {
			{
				...
				BlockState _bs = WorldExpansionModBlocks.HANGING_BOTTLE_WITN_MINI_FIREFLIES.get().defaultBlockState();
