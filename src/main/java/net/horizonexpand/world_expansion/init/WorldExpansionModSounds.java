...
public class WorldExpansionModSounds {
	...
	public static final RegistryObject<SoundEvent> HARMONY1 = REGISTRY.register("harmony1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony1")));
	public static final RegistryObject<SoundEvent> HARMONY2 = REGISTRY.register("harmony2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony2")));
	public static final RegistryObject<SoundEvent> HARMONY3 = REGISTRY.register("harmony3", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony3")));
	public static final RegistryObject<SoundEvent> HARMONY4 = REGISTRY.register("harmony4", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony4")));
	public static final RegistryObject<SoundEvent> HARMONY5 = REGISTRY.register("harmony5", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony5")));
	public static final RegistryObject<SoundEvent> HARMONY6 = REGISTRY.register("harmony6", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony6")));
	public static final RegistryObject<SoundEvent> HARMONY7 = REGISTRY.register("harmony7", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony7")));
	public static final RegistryObject<SoundEvent> HARMONY8 = REGISTRY.register("harmony8", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony8")));
	public static final RegistryObject<SoundEvent> HARMONY9 = REGISTRY.register("harmony9", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "harmony9")));
	public static final RegistryObject<SoundEvent> MELODY1 = REGISTRY.register("melody1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody1")));
	public static final RegistryObject<SoundEvent> MELODY2 = REGISTRY.register("melody2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody2")));
	public static final RegistryObject<SoundEvent> MELODY3 = REGISTRY.register("melody3", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody3")));
	public static final RegistryObject<SoundEvent> MELODY4 = REGISTRY.register("melody4", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody4")));
	public static final RegistryObject<SoundEvent> MELODY5 = REGISTRY.register("melody5", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody5")));
	public static final RegistryObject<SoundEvent> MELODY6 = REGISTRY.register("melody6", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "melody6")));
	...
	public static final RegistryObject<SoundEvent> BASS2 = REGISTRY.register("bass2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass2")));
	public static final RegistryObject<SoundEvent> BASS3 = REGISTRY.register("bass3", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass3")));
	public static final RegistryObject<SoundEvent> BASS4 = REGISTRY.register("bass4", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass4")));
	public static final RegistryObject<SoundEvent> BASS5 = REGISTRY.register("bass5", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass5")));
	public static final RegistryObject<SoundEvent> BASS6 = REGISTRY.register("bass6", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass6")));
	public static final RegistryObject<SoundEvent> BASS7 = REGISTRY.register("bass7", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass7")));
	public static final RegistryObject<SoundEvent> BASS8 = REGISTRY.register("bass8", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("world_expansion", "bass8")));
