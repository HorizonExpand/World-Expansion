...
public class WorldExpansionMod {
	...
	public WorldExpansionMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		//MinecraftForge.EVENT_BUS.addListener(this::addPackFinder);
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		WorldExpansionModSounds.REGISTRY.register(modEventBus);
		WorldExpansionModBlocks.REGISTRY.register(modEventBus);
		WorldExpansionModBlockEntities.REGISTRY.register(modEventBus);
		WorldExpansionModItems.REGISTRY.register(modEventBus);
		WorldExpansionModEntities.REGISTRY.register(modEventBus);
		WorldExpansionModTabs.REGISTRY.register(modEventBus);
		WorldExpansionModVariables.ATTACHMENT_TYPES.register(modEventBus);
		WorldExpansionModFeatures.REGISTRY.register(modEventBus);
		StructureFeature.REGISTRY.register(modEventBus);
		WorldExpansionModMenus.REGISTRY.register(modEventBus);
		WorldExpansionModAttributes.REGISTRY.register(modEventBus);
