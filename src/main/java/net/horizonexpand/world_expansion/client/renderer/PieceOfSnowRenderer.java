...
public class PieceOfSnowRenderer extends EntityRenderer<PieceOfSnowEntity> {
	private static final ResourceLocation texture = new ResourceLocation("world_expansion:textures/entities/snow_projectile.png");
	...
	@Override
	public void render(PieceOfSnowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(PieceOfSnowEntity entity) {
		return texture;
	}
}
