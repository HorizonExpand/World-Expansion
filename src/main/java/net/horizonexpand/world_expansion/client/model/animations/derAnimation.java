...
public class derAnimation {
	public static final AnimationDefinition test = AnimationDefinition.Builder.withLength(0.5F).looping()
			.addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 275.976F, 0.0F), AnimationChannel.Interpolations.LINEAR))).build();
}
