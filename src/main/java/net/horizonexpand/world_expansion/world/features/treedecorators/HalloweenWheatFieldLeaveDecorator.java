...
public class HalloweenWheatFieldLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(HalloweenWheatFieldLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("halloween_pumpkin_field_tree_leave_decorator", DECORATOR_TYPE));
	}

	public HalloweenWheatFieldLeaveDecorator() {
		super(0.25f);
	}
