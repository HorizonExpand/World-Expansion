...
public class HalloweenWheatFieldTrunkDecorator extends TrunkVineDecorator {
	public static Codec<HalloweenWheatFieldTrunkDecorator> CODEC = Codec.unit(HalloweenWheatFieldTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("halloween_pumpkin_field_tree_trunk_decorator", DECORATOR_TYPE));
	}
