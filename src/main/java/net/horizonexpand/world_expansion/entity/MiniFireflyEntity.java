...
public class MiniFireflyEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MiniFireflyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MiniFireflyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MiniFireflyEntity.class, EntityDataSerializers.STRING);
	...
	public MiniFireflyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WorldExpansionModEntities.MINI_FIREFLIES.get(), world);
	}

	public MiniFireflyEntity(EntityType<MiniFireflyEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MiniFireflyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
