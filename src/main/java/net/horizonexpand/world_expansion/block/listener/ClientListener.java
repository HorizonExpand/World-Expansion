...
import net.horizonexpand.world_expansion.block.renderer.HangingBottleWitnMiniFirefliesTileRenderer;
import net.horizonexpand.world_expansion.block.renderer.HangingBottleTileRenderer;
