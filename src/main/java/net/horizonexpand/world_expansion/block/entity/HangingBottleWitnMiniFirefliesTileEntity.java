...
public class HangingBottleWitnMiniFirefliesTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public HangingBottleWitnMiniFirefliesTileEntity(BlockPos pos, BlockState state) {
		super(WorldExpansionModBlockEntities.HANGING_BOTTLE_WITN_MINI_FIREFLIES.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<HangingBottleWitnMiniFirefliesTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<HangingBottleWitnMiniFirefliesTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("hanging_bottle_witn_mini_fireflies");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Hanging Bottle Witn Mini Fireflies");
	}
